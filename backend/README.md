...
## Project Structure
    ...
    ├── testapiautosetting_125921  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125921`
...
2. Clone this repo and `cd testapiautosetting_125921`
